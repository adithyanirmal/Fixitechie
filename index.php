<?php
include "../db.php";
$records = mysqli_query($db,"select * from shop"); // fetch data from database
?>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><div class="rounded-circle"><img class="rounded-circle" style="width: 40px; height: 40px" src="uploads/<?=$data['img']?>"  /></div></td>  
                                    <td><a class="btn btn-sm btn-primary" href="delete.php?id=<?php echo $data['ID']; ?>">Delete</a></td>
                                </tr>
                               <?php
                               }
                               ?>
