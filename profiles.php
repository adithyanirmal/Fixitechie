<?php
include "../db.php";
$records = mysqli_query($db,"select * from profile"); // fetch data from database
?>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href=""><font color="#d50cec">Show All</font></a>
                    </div>
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['Started_Date'];?></td>
                                    <td><?php echo $data['Address'];?></td>
                                    <td><?php echo $data['City'];?></td>
                                    <td><?php echo $data['about'];?></td>
                                    <td><div class="rounded-circle"><img class="rounded-circle" style="width: 40px; height: 40px" src="../Profile/uploads/<?=$data['img']?>"></div></td>
                                    <td><?php echo $data['Owner_name'];?></td>
                                    <td><?php echo $data['type'];?></td>
                                     
                                    <td><a class="btn btn-sm btn-primary" href="../Profile/index.php?name=<?php echo $data['logName']; ?>">Acess</a></td>
                                </tr>
                               <?php
                               }
                               ?>
